      ...
      {loading ? (
        ...
        <>
            ...
            <div className="row d-flex  align-items-center justify-content-around">
              <div className="col-lg-6 col-md-6 col-6 ps-5">
                <h2 className="herotext">
                  Browse, click, buy <br></br> the modern mantra of shopping.
                </h2>
                <p className="herosubtext">
                  In the era of e-commerce, every click is a step into a realm
                  of curated convenience. The beauty of online shopping lies not
                  just in the products it delivers but in the stories it tells,
                  the trends it unveils, and the seamless connection it forges
                  between desire and doorstep.
                </p>
                ...
                <div class="card detailscard text-center bg-light shadow-lg">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      <small>
                        {" "}
                        Clients are not satisfied with an order, the items can
                        be returned Easily
                      </small>
                    </p>
                  </div>
          ...
          <div className="container homecontainer  ">
            <div className="row ">
              <h6 className="newlylaunchtext ">Our Products</h6>
          ...
          <div className="container latestcontainer border rounded-3 shadow-lg">
            <div className="row d-flex  text-center align-items-center justify-content-center p-4  ">
              <div className="col-lg-12 col-md-12 col-12">
                <h3>Incrediable collections waiting for you !</h3>
