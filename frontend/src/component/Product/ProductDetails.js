...
const ProductDetails = () => {
  ...
  const addToCartHandler = () => {
    if (!isAuthenticated) {
      toast.error("please signup/login to Add the product to cart ");
    } else {
  ...
  const submitReviewToggle = () => {
    if (!isAuthenticated) {
      toast.error("please signup/login to submit the  review");
    } else {
        ...
        <>
          ...
          <div className="container ">
            <div className="row d-flex align-items-center justify-content-around ">
              ...
              <div className="col col-md-6 col-12 text-center detailimagecontainer mt-4 bg-light p-4 rounded-3 ">
                {product.images &&
              ...
              <div className="col col-md-6 col-12  productdetailstext  mt-5 pt-4 ">
                <p>
                  <small>ID : {product._id}</small>
                </p>
                <hr className="producthr" />
                <p>
                  <small className="fw-bold">Product : {product.name}</small>
                </p>
                ...
                <div className="d-flex align-items-center  mt-3">
                  <button
                    className=" btn shadow-lg btn-sm neumorphin productdetailsbutton"
                  ...
                  <button
                    className=" btn neumorphin btn-sm ms-3 productdetailsbutton"
